...
__all__ = [
    ...
    'ISpeechGrammarRules',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpNotifySink',
    'DISPID_SPIEngineId', 'eLEXTYPE_PRIVATE10', 'ISpObjectToken',
    'Speech_Default_Weight', 'SPEI_HYPOTHESIS', 'DISPID_SPRsItem',
    'SPSLMA', 'SSTTTextBuffer', 'SRESoundEnd', 'SpInProcRecoContext',
    'SPEI_RESERVED1', 'SPWT_PRONUNCIATION', 'SPRST_INACTIVE',
    'SpeechRecognitionType', 'SAFTADPCM_44kHzStereo', 'SP_VISEME_19',
    'SGRSTTWord', 'ISpAudio', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechEngineConfidence', 'SGDisplay', 'DISPID_SPIProperties',
    'DISPID_SOTCreateInstance', 'DISPID_SpeechVoice',
    'SVSFPurgeBeforeSpeak', 'SDTAudio', 'DISPID_SRGCmdLoadFromObject',
    'SPRST_NUM_STATES', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPAsItem', 'DISPID_SBSRead',
    'DISPID_SRGCmdSetRuleState', 'ISpeechObjectToken',
    'DISPID_SRRSetTextFeedback', 'SPWORD', 'SREPrivate',
    'SpeechPropertyAdaptationOn', 'DISPID_SDKSetStringValue',
    'SpeechTokenKeyFiles', 'SPEI_TTS_BOOKMARK', 'SPEI_RESERVED5',
    'SPRECOSTATE', 'DISPIDSPTSI_ActiveLength', 'SPEI_START_SR_STREAM',
    'DISPID_SDKEnumKeys', 'DISPID_SOTsCount', 'DISPIDSPRG',
    'ISpEventSink', 'DISPID_SOTCDefault', 'DISPID_SpeechMemoryStream',
    'SSFMOpenForRead', 'DISPID_SGRSAddWordTransition',
    'DISPID_SPRNumberOfElements', 'SAFTCCITT_uLaw_8kHzMono',
    'SRERecognition', 'ISpRecoResult', 'DISPID_SPEEngineConfidence',
    'SRTSMLTimeout', 'SRAONone', 'DISPID_SRRRecoContext',
    'SpCustomStream', 'eLEXTYPE_PRIVATE7', 'ISpeechPhraseProperty',
    'DISPID_SGRSTPropertyName', '_ISpeechRecoContextEvents',
    'DISPID_SPPParent', 'DISPID_SGRSRule', 'ISpeechPhraseInfoBuilder',
    'SPVPRI_ALERT', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SLWLangId', 'DISPID_SVEStreamStart',
    'DISPID_SPAStartElementInResult', 'DISPID_SDKCreateKey',
    'DISPID_SOTCId', 'DISPID_SRRDiscardResultInfo',
    'SpPhraseInfoBuilder', 'SVEViseme', 'DISPID_SAFType',
    'DISPID_SRSAudioStatus', 'DISPID_SRCState',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVPause',
    'DISPID_SAEventHandle', 'SpeechDiscardType', 'SVP_3',
    'DISPID_SpeechAudioStatus', 'SP_VISEME_13',
    'SpeechEngineProperties', 'DISPID_SABufferInfo',
    'SRAORetainAudio', 'SECLowConfidence',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SGRsFindRule',
    'DISPID_SMSSetData', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'eLEXTYPE_PRIVATE20', 'DISPID_SLPSymbolic', 'ISpObjectWithToken',
    'SAFT12kHz16BitMono', 'DISPID_SGRSTWeight',
    'SPINTERFERENCE_NOISE', 'DISPID_SLPPhoneIds', 'SPCS_DISABLED',
    'eLEXTYPE_PRIVATE6', 'DISPID_SPPsItem', 'SGRSTTEpsilon',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRCResume', 'SRERequestUI',
    'DISPIDSPTSI_ActiveOffset', 'SPSHT_NotOverriden', 'SPSHT_OTHER',
    'DISPID_SGRSTsCount', 'ISpPhraseAlt', 'DISPID_SLWsCount',
    'SPSHT_EMAIL', 'DISPID_SVSInputSentencePosition',
    'DISPID_SVSPhonemeId', 'SRSEIsSpeaking', 'SAFTADPCM_11kHzMono',
    'SPSEMANTICFORMAT', 'eLEXTYPE_PRIVATE18', 'SPCONTEXTSTATE',
    'SLTUser', 'SPEVENTENUM', 'DISPID_SpeechGrammarRule',
    'SpeechRecognizerState', 'DISPID_SpeechLexicon', 'SINoise',
    'DISPID_SVESentenceBoundary',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPEsItem',
    'DISPID_SWFEExtraData', 'SRARoot', 'SP_VISEME_10', 'SPRS_ACTIVE',
    'DISPID_SVSInputWordLength', 'ISpeechLexiconWord',
    'DISPID_SPPConfidence', 'DISPID_SOTGetDescription',
    'DISPID_SRCEPhraseStart', 'SREHypothesis',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPAsCount',
    'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechLexicon',
    'ISpRecognizer', 'DISPID_SpeechLexiconWord', 'SWTDeleted',
    'STCLocalServer', 'SREAllEvents', 'DISPID_SVWaitUntilDone',
    'SPAUDIOBUFFERINFO', 'DISPID_SVSpeakCompleteEvent',
    'SpeechLexiconType', 'SVEBookmark', 'SpeechDataKeyLocation',
    'ISpeechRecognizerStatus', 'DISPID_SRRPhraseInfo',
    'SPCT_SUB_COMMAND', 'SPSHT_Unknown', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechVoiceSpeakFlags', 'DISPID_SABufferNotifySize',
    'SpeechAudioFormatGUIDWave', 'SPEI_WORD_BOUNDARY', 'SPXRO_SML',
    'ISpRecognizer3', 'SAFTADPCM_22kHzMono',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SGRsDynamic',
    'SPBINARYGRAMMAR', 'DISPID_SDKGetlongValue', 'SINoSignal',
    'eLEXTYPE_RESERVED9', 'SRSInactive', 'DISPID_SABIEventBias',
    'DISPID_SAStatus', 'SPFM_OPEN_READWRITE', 'SPLOADOPTIONS',
    'SPPS_Noun', 'SAFT48kHz8BitStereo', 'SRSActiveAlways',
    'SAFT32kHz16BitMono', 'DISPID_SDKDeleteValue',
    'DISPID_SASFreeBufferSpace', 'SpeechCategoryVoices',
    'DISPID_SGRsItem', 'SPDKL_CurrentUser', 'SPWF_SRENGINE',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SRGReset',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPEAudioSizeTime', 'SPFILEMODE',
    'DISPID_SRCEStartStream', 'SAFT8kHz16BitMono', 'SPAR_Unknown',
    'SPPHRASEELEMENT', 'SPCS_ENABLED', 'SVSFIsXML', 'SVP_17',
    'SpeechTokenKeyAttributes', 'SPPS_Function',
    'DISPID_SPEDisplayAttributes', 'SSTTDictation',
    'SAFT16kHz8BitMono', 'DISPID_SVGetVoices', 'SAFT16kHz8BitStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPAS_STOP',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechPartOfSpeech',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRCRetainedAudioFormat',
    'ISpeechDataKey', 'SpeechTokenShellFolder', 'ISpProperties',
    'SPEI_MAX_TTS', 'SpeechCategoryAudioIn', 'SAFT32kHz16BitStereo',
    'ISequentialStream', 'SpShortcut', 'SpVoice',
    'DISPID_SPRuleConfidence', 'SBOPause', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRRAlternates', 'Speech_StreamPos_Asap',
    'SpeechVisemeType', 'SpeechVoiceEvents',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SMSADeviceId',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechRecognizer',
    'SRERecoOtherContext', 'DISPID_SRGId', 'SpeechAddRemoveWord',
    'ISpRecoGrammar', 'SWTAdded', 'SpeechVisemeFeature',
    'DISPID_SPEs_NewEnum', 'SBONone', 'DISPID_SGRAttributes',
    'SPPHRASEREPLACEMENT', 'SVP_6', 'DISPID_SRProfile',
    'DISPID_SVDisplayUI', 'DISPID_SGRSTs_NewEnum', 'SPSInterjection',
    'SGDSActiveUserDelimited', 'SPAUDIOOPTIONS',
    'DISPID_SpeechPhraseRule', 'DISPID_SpeechRecoResultTimes',
    'SpFileStream', 'SSSPTRelativeToStart', 'SpCompressedLexicon',
    'DISPID_SpeechAudioFormat', 'SpeechCategoryAppLexicons',
    'SDTAlternates', 'SPSModifier', 'DISPID_SpeechObjectTokens',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRCEAudioLevel',
    'DISPID_SPIEnginePrivateData', 'SPSNoun',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPRuleEngineConfidence',
    'SPPS_Modifier', 'DISPID_SGRInitialState', 'DISPID_SWFEFormatTag',
    'DISPID_SRSSupportedLanguages', 'SECFIgnoreKanaType',
    'DISPID_SBSWrite', 'DISPID_SVGetAudioOutputs',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVEEndInputStream', 'SPBO_AHEAD',
    'SPRECOGNIZERSTATUS', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_8',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpEventSource',
    'ISpeechPhraseRule', 'DISPID_SLGetWords', 'DISPID_SBSFormat',
    'DISPID_SPCIdToPhone', 'SDA_Consume_Leading_Spaces', 'SVP_2',
    'DISPID_SRCESoundStart', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SWFEChannels', 'DISPID_SLPs_NewEnum', 'DISPID_SPIRule',
    'Speech_Max_Word_Length', 'ISpVoice', 'DISPID_SCSBaseStream',
    'SVEVoiceChange', 'SAFT16kHz16BitStereo', 'DISPID_SRAudioInput',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechPhraseBuilder',
    'SAFTADPCM_44kHzMono', 'SDKLDefaultLocation',
    'SAFTADPCM_8kHzStereo', 'SRTExtendableParse',
    'SAFTNoAssignedFormat', 'SpeechGrammarTagWildcard',
    'DISPID_SOTId', 'SREStateChange', 'SVSFIsNotXML', 'SVP_8',
    'eLEXTYPE_PRIVATE17', 'DISPID_SGRSTransitions',
    'ISpeechPhraseAlternates', 'SAFT24kHz8BitStereo',
    'SAFT12kHz8BitStereo', 'SpeechStreamSeekPositionType', 'SVP_20',
    'ISpDataKey', 'SSFMCreateForWrite', 'eLEXTYPE_VENDORLEXICON',
    'SVEAudioLevel', 'ISpeechPhraseAlternate', 'SpNullPhoneConverter',
    'SpeechRunState', 'SpeechVoicePriority',
    'ISpeechObjectTokenCategory', 'SAFT8kHz16BitStereo',
    'SPEI_SR_BOOKMARK', 'DISPID_SRGetPropertyString', 'SDTProperty',
    'SPFM_CREATE_ALWAYS', 'SPAR_Low', 'DISPID_SRCRequestedUIType',
    'SVF_Stressed', 'SVSFNLPMask', 'DISPID_SRAudioInputStream',
    'SECFDefault', 'ISpeechRecognizer', 'SAFT32kHz8BitMono', 'SINone',
    'DISPID_SPIElements', 'Speech_StreamPos_RealTime',
    'ISpeechRecoResultDispatch', 'ISpeechPhraseElements',
    'SAFT24kHz16BitMono', 'SpeechAllElements', 'eLEXTYPE_RESERVED10',
    'ISpSerializeState', 'DISPID_SAFGuid', 'SpSharedRecoContext',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SGRSTRule',
    ...
    'DISPID_SLWs_NewEnum', 'SAFT24kHz8BitMono', 'DISPID_SASetState',
    'DISPID_SRRAudio', 'SAFT32kHz8BitStereo', 'DISPID_SRRTTickCount',
    'SpeechGrammarTagDictation', 'DISPID_SPIAudioSizeBytes',
    'SP_VISEME_7', 'SVP_4', 'eLEXTYPE_RESERVED6', 'DISPID_SPPsCount',
    'DISPID_SVEAudioLevel', 'DISPID_SOTRemove', 'SPSSuppressWord',
    'SITooSlow', 'SAFTCCITT_uLaw_8kHzStereo', 'SpSharedRecognizer',
    'SGSEnabled', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPSFunction', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPRDisplayAttributes', 'SAFT44kHz16BitMono',
    'SPEI_FALSE_RECOGNITION', 'SPEI_ADAPTATION', 'SP_VISEME_4',
    'DISPID_SVEBookmark', 'ISpeechAudioBufferInfo', 'ISpPhrase',
    'eLEXTYPE_USER', 'SAFT24kHz16BitStereo', 'DISPID_SGRsCommit',
    'SGDSInactive', 'SPWF_INPUT', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SDKSetLongValue', 'SPRULE', 'SPSMF_SAPI_PROPERTIES',
    'SVPAlert', 'DISPID_SRCreateRecoContext',
    'SPEI_SENTENCE_BOUNDARY', 'SPPHRASEPROPERTY',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT44kHz8BitStereo',
    'SVEPrivate', 'UINT_PTR', 'DISPID_SGRsCount',
    'SAFT8kHz8BitStereo', 'SREPropertyNumChange',
    'SPFM_OPEN_READONLY', 'DISPID_SRRGetXMLResult',
    'SPEI_TTS_PRIVATE', 'DISPID_SPRuleName', 'SPEI_INTERFERENCE',
    'DISPID_SRCBookmark', 'SDA_One_Trailing_Space',
    'SAFTCCITT_ALaw_22kHzMono', 'SPPS_RESERVED3',
    'SPWORDPRONUNCIATIONLIST', 'SPEI_VISEME',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_UNDEFINED',
    'SPEI_PHRASE_START', 'SASPause', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRRSpeakAudio', 'SVF_Emphasis', 'ISpeechResourceLoader',
    'DISPID_SPEActualConfidence', 'ISpeechRecoResult',
    'SVSFIsFilename', 'SPEI_PHONEME', 'SVSFUnusedFlags',
    'SpeechTokenIdUserLexicon', 'SSSPTRelativeToEnd',
    'SpeechRecoProfileProperties', 'SPGRAMMARWORDTYPE',
    'SPCT_COMMAND', 'SPAUDIOSTATUS', 'SP_VISEME_14',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFParseSsml',
    'STSF_LocalAppData', 'SpeechMicTraining', 'DISPID_SOTCSetId',
    'ISpShortcut', 'SAFTGSM610_11kHzMono', 'ISpeechPhoneConverter',
    'SVEStartInputStream', 'SPSERIALIZEDPHRASE', 'DISPID_SGRName',
    'SVP_12', 'DISPID_SVSpeakStream', 'SP_VISEME_1',
    'SAFT22kHz16BitStereo', 'SPEI_MIN_SR', 'DISPID_SPISaveToMemory',
    'ISpeechAudioStatus', 'SVP_10', 'SPEI_END_SR_STREAM',
    'SAFT16kHz16BitMono', 'SAFT8kHz8BitMono', 'SECFEmulateResult',
    'SECHighConfidence', 'SAFTNonStandardFormat', 'STSF_FlagCreate',
    'SAFT44kHz8BitMono', 'SPWAVEFORMATTYPE',
    'SAFTCCITT_ALaw_44kHzStereo', 'SGRSTTDictation',
    'SECFNoSpecialChars', 'ISpResourceManager', 'DISPID_SVSpeak',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechPhraseRules', 'SpeechGrammarWordType',
    'DISPID_SPPEngineConfidence', 'SPEI_END_INPUT_STREAM',
    '_ISpeechVoiceEvents', 'DISPID_SPPFirstElement', 'SREPhraseStart',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPAO_NONE', '_RemotableHandle',
    'STCAll', 'SGDSActive', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVEVoiceChange', 'SVSFlagsAsync', 'DISPID_SDKEnumValues',
    'DISPID_SGRClear', 'DISPID_SWFESamplesPerSec',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SBSSeek',
    'SSTTWildcard', 'SRADynamic', 'SpeechTokenValueCLSID',
    'DISPID_SPIStartTime', 'DISPID_SRGetFormat',
    'DISPID_SRSetPropertyString', 'SP_VISEME_15',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPCPhoneToId', 'SRTStandard',
    'DISPID_SGRSAddRuleTransition', 'eLEXTYPE_RESERVED4',
    'DISPID_SLGetPronunciations', 'DISPID_SASNonBlockingIO',
    'SWPKnownWordPronounceable', 'SpeechAudioVolume',
    'ISpeechPhraseProperties', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SVEWord', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPBO_TIME_UNITS', 'eLEXTYPE_PRIVATE15',
    'SpPhoneticAlphabetConverter', 'SpMMAudioIn',
    'SpTextSelectionInformation', 'SAFT44kHz16BitStereo',
    'SPWT_DISPLAY', 'SECFIgnoreWidth', 'DISPID_SPRuleChildren',
    'SpeechCategoryRecognizers', 'DISPID_SGRSTText', 'SVEPhoneme',
    'WAVEFORMATEX', 'DISPID_SRCVoice', 'DISPID_SRCEFalseRecognition',
    'SPEI_MAX_SR', 'SpPhoneConverter', 'SAFT11kHz16BitMono',
    'ISpXMLRecoResult', 'IStream', 'SPEVENT',
    'DISPID_SVIsUISupported', 'DISPID_SMSAMMHandle',
    'ISpeechObjectTokens', 'SAFT48kHz16BitMono',
    'DISPID_SGRSTNextState', 'SPEI_RESERVED2', 'DISPID_SPACommit',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRSetPropertyNumber',
    'DISPID_SLGenerationId', 'DISPID_SLPType', 'SAFT11kHz8BitMono',
    'ISpNotifyTranslator', 'DISPID_SPPId', 'ISpRecoCategory',
    'SAFTGSM610_44kHzMono', 'ISpeechLexiconPronunciations',
    'ISpeechRecoContext', 'SVPNormal', 'ISpStreamFormatConverter',
    'DISPID_SRGetRecognizers', 'SAFTCCITT_ALaw_11kHzStereo',
    'SRAInterpreter', 'eLEXTYPE_PRIVATE2', 'SAFT22kHz16BitMono',
    'SpeechRuleAttributes', 'DISPID_SLWsItem',
    'SAFTCCITT_ALaw_8kHzMono', 'STCInprocServer', 'IEnumString',
    'SVSFDefault', 'SPAR_High', 'DISPID_SLGetGenerationChange',
    'SAFTADPCM_22kHzStereo', 'ISpeechAudio',
    'DISPID_SpeechMMSysAudio', 'SSFMCreate',
    'DISPID_SpeechPhraseRules', 'SPCT_SLEEP',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPRules_NewEnum',
    'SVP_19', 'SAFTExtendedAudioFormat', 'ISpeechMemoryStream',
    'SGPronounciation', 'SAFTGSM610_8kHzMono',
    'SAFTCCITT_ALaw_11kHzMono', 'SPRECORESULTTIMES',
    'DISPID_SpeechFileStream', 'DISPID_SRGState',
    'DISPID_SPRFirstElement', 'SSFMOpenReadWrite',
    'DISPID_SLAddPronunciationByPhoneIds', 'SGSDisabled', 'SPPHRASE',
    'SREStreamEnd', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_MIN_TTS', 'DISPID_SGRSTPropertyId',
    'SPINTERFERENCE_TOOSLOW', 'ISpRecoContext2',
    'SPWORDPRONUNCIATION', 'SPEI_RESERVED3', 'ISpPhoneConverter',
    'SPBOOKMARKOPTIONS', 'SPSERIALIZEDRESULT', 'SVP_14',
    'SpeechSpecialTransitionType', 'SpStream', 'SECFIgnoreCase',
    'SRCS_Disabled', 'DISPID_SOTCategory', 'SpWaveFormatEx',
    'SpeechDictationTopicSpelling', 'DISPID_SOTCEnumerateTokens',
    'SpeechLoadOption', '_SPAUDIOSTATE', 'SREAdaptation',
    'eLEXTYPE_PRIVATE19', 'SPEI_SOUND_END', 'SpeechDisplayAttributes',
    'DISPID_SOTIsUISupported', 'ISpeechRecoGrammar',
    'DISPID_SRCPause', 'SP_VISEME_0', 'DISPID_SOTs_NewEnum', 'SLTApp',
    'SpStreamFormatConverter', 'DISPID_SPAPhraseInfo',
    'DISPIDSPTSI_SelectionLength', 'SP_VISEME_5',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPRuleFirstElement',
    'SPSHORTCUTPAIR', 'DISPID_SDKOpenKey', 'SRSInactiveWithPurge',
    'SpeechStreamFileMode', 'SRTEmulated',
    'DISPID_SRGDictationSetState', 'SpeechAudioFormatGUIDText',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechObjectToken',
    'DISPID_SRRSaveToMemory', 'SpeechPropertyResponseSpeed',
    'SpeechWordType', 'DISPID_SRGSetTextSelection',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT22kHz8BitStereo',
    'SPPS_NotOverriden', 'DISPID_SpeechRecoContextEvents',
    'SAFT11kHz8BitStereo', 'DISPID_SRCRecognizer', 'SRCS_Enabled',
    'SLOStatic', 'SPDATAKEYLOCATION', 'SASRun', 'SVESentenceBoundary',
    'SpeechVoiceCategoryTTSRate', '__MIDL_IWinTypes_0009',
    'SpeechBookmarkOptions', 'SRTAutopause', 'SP_VISEME_11',
    'SP_VISEME_18', 'DISPID_SRGCommit', 'SGDSActiveWithAutoPause',
    'DISPID_SRCEEnginePrivate', 'IInternetSecurityManager',
    'SpObjectToken', 'SPSVerb', 'SAFT12kHz16BitStereo',
    'DISPID_SVSLastResult', 'DISPID_SRState', 'SPVISEMES',
    'ISpeechLexiconWords', 'DISPID_SpeechXMLRecoResult',
    'SpeechPropertyLowConfidenceThreshold', 'SPCATEGORYTYPE',
    'SVP_11', 'SITooFast', 'ISpeechVoiceStatus',
    'ISpObjectTokenCategory', 'DISPID_SVVolume',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechLexiconPronunciation',
    'DISPID_SPPChildren', 'SPPS_RESERVED2',
    'DISPID_SPERequiredConfidence', 'SVSFParseMask',
    'SWPUnknownWordPronounceable', 'SPPS_RESERVED4',
    'SPEI_VOICE_CHANGE', 'SRADefaultToActive',
    'DISPID_SLAddPronunciation', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRCCreateGrammar', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPAs_NewEnum', 'ISpeechCustomStream', 'SPAUDIOSTATE',
    'SP_VISEME_3', 'SPPHRASERULE', 'SPSUnknown',
    'SPADAPTATIONRELEVANCE', 'SP_VISEME_21', 'DISPID_SPRuleParent',
    'SPFM_NUM_MODES', 'DISPID_SpeechRecoResult2',
    'DISPID_SRCERecognizerStateChange', 'SpeechRecoEvents',
    'SPINTERFERENCE', 'SREPropertyStringChange', 'DISPID_SRStatus',
    'DISPID_SLPsItem', 'SPPS_RESERVED1',
    'DISPID_SASCurrentDevicePosition', 'SITooQuiet',
    'DISPID_SpeechAudioBufferInfo', 'SPBO_NONE',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechBaseStream',
    'DISPID_SRRecognizer', 'SVP_1', 'DISPID_SVVoice',
    'SpeechGrammarState', 'SPINTERFERENCE_NONE', 'SVPOver',
    'DISPID_SRCCreateResultFromMemory', 'eLEXTYPE_APP',
    'ISpeechFileStream', 'ISpeechGrammarRule', 'SFTSREngine',
    'ISpeechVoice', 'SVP_13', 'SPEI_REQUEST_UI', 'SpAudioFormat',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SpeechBaseStream',
    'SRESoundStart', 'SP_VISEME_20', 'DISPID_SVEStreamEnd',
    'SPXMLRESULTOPTIONS', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SDKGetBinaryValue', 'DISPID_SOTGetStorageFileName',
    'ISpLexicon', 'SpUnCompressedLexicon', 'SPLO_DYNAMIC',
    'DISPID_SASState', 'SPEI_RECOGNITION', 'SPTEXTSELECTIONINFO',
    'DISPID_SPIGetText', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRRTStreamTime', 'SPPS_SuppressWord',
    'ISpeechGrammarRuleStateTransition', 'ISpeechPhraseReplacement',
    'ISpStreamFormat', 'DISPID_SPPName', 'SAFT48kHz16BitStereo',
    'SPEI_PROPERTY_STRING_CHANGE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVEAllEvents',
    'SPVPRI_OVER', 'SAFT48kHz8BitMono',
    'DISPID_SOTRemoveStorageFileName', 'ISpRecoGrammar2',
    'DISPID_SOTSetId', 'DISPID_SPRuleNumberOfElements',
    'SPGS_ENABLED', 'DISPID_SLRemovePronunciation', 'SRAImport',
    'DISPID_SVStatus', 'SPGS_EXCLUSIVE', 'ISpRecoContext',
    'SPRST_INACTIVE_WITH_PURGE', 'SpLexicon',
    'tagSPTEXTSELECTIONINFO', 'SREBookmark', 'SPWORDTYPE',
    'DISPID_SVAlertBoundary', 'SDKLCurrentUser', 'SPLO_STATIC',
    'SFTInput', 'DISPID_SVEViseme', 'ISpeechPhraseReplacements',
    'SPRULESTATE', 'SDTPronunciation', 'DISPID_SOTCGetDataKey',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVEventInterests',
    'DISPID_SpeechRecoResult', 'SPLEXICONTYPE',
    'ISpeechTextSelectionInformation', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SLPLangId', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRIsShared',
    'DISPID_SOTDataKey', 'SPAS_CLOSED', 'SPWORDLIST', 'SPVPRIORITY',
    'SpeechRetainedAudioOptions', 'DISPID_SVRate',
    'DISPID_SVSVisemeId', 'SDKLCurrentConfig', 'DISPID_SMSGetData',
    'DISPID_SpeechVoiceStatus', 'ISpeechRecoResultTimes',
    'SpeechCategoryRecoProfiles', 'ISpRecognizer2', 'SRSEDone',
    'SVP_16', 'eLEXTYPE_PRIVATE13', 'SpObjectTokenCategory',
    'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SGRSTType',
    'DISPID_SGRAddState', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRCEEndStream', 'DISPID_SWFEBlockAlign',
    'SPDKL_LocalMachine', 'SpeechTokenKeyUI',
    'SpeechEmulationCompareFlags', 'SVSFParseAutodetect',
    'SPINTERFERENCE_LATENCY_WARNING', 'SP_VISEME_9',
    'DISPID_SPRuleId', 'SP_VISEME_6',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRSTPropertyValue',
    'SAFTText', 'SDTAll', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SVGetAudioInputs', 'DISPID_SDKDeleteKey',
    'DISPID_SRDisplayUI', 'SVF_None', 'SpeechAudioState',
    'SPWT_LEXICAL', 'DISPID_SPPs_NewEnum',
    'DISPID_SPPBRestorePhraseFromMemory', 'eWORDTYPE_DELETED',
    'DISPID_SpeechPhraseReplacement', 'SGRSTTWildcard',
    'SAFTADPCM_11kHzStereo', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechPhraseProperty',
    'DISPID_SpeechGrammarRules', 'SPVOICESTATUS', 'SpeechFormatType',
    'DISPID_SVResume', 'DISPID_SpeechDataKey', 'ISpeechXMLRecoResult',
    'ISpeechPhraseInfo', 'DISPID_SPRsCount', 'SASStop', 'SPSMF_UPS',
    'SGLexical', 'DISPID_SVSkip', 'SLODynamic', 'SPGRAMMARSTATE',
    'DISPID_SAFGetWaveFormatEx', 'SpeechCategoryPhoneConverters',
    'SAFTCCITT_uLaw_11kHzMono', 'SDA_No_Trailing_Space',
    'SREFalseRecognition', 'SPBO_PAUSE', 'SpeechRuleState',
    'DISPID_SRSCurrentStreamNumber', 'SDTLexicalForm',
    'SpeechWordPronounceable', 'DISPID_SGRSTsItem', 'SpMMAudioEnum',
    'eLEXTYPE_RESERVED7', 'Speech_Max_Pron_Length', 'SGSExclusive',
    'SPCT_SUB_DICTATION', 'DISPID_SMSALineId', 'SAFTDefault',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SDKGetStringValue',
    'ISpPhoneticAlphabetConverter', 'SPDKL_CurrentConfig',
    'DISPID_SpeechPhraseProperties', 'SWPUnknownWordUnpronounceable',
    'SPGS_DISABLED', 'SpMemoryStream', 'SpeechAudioProperties',
    'DISPID_SPRulesItem', 'SPSEMANTICERRORINFO',
    'SpeechRecoContextState', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechCustomStream',
    'ISpStream', 'DISPID_SRSNumberOfActiveRules', 'DISPID_SLWWord',
    'SPSNotOverriden', 'eWORDTYPE_ADDED', 'DISPID_SRCEHypothesis',
    'DISPID_SGRsCommitAndSave', 'DISPID_SLPsCount',
    'DISPID_SASCurrentSeekPosition', 'SRAExport',
    'DISPID_SVAudioOutput', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRCEventInterests', 'DISPID_SPILanguageId',
    'DISPID_SRGDictationUnload', 'DISPID_SPPValue', 'SVP_0',
    'SpeechUserTraining', 'DISPID_SRGIsPronounceable',
    'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFT12kHz8BitMono',
    'DISPID_SABIMinNotification', 'SGLexicalNoSpecialChars',
    'SpeechInterference', 'SDTDisplayText', 'SVP_9',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SGRsAdd',
    'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRGSetWordSequenceData', 'SPPS_Noncontent',
    'DISPID_SRIsUISupported', 'SAFTCCITT_ALaw_22kHzStereo',
    'SP_VISEME_12', 'DISPID_SOTDisplayUI', 'DISPID_SGRs_NewEnum',
    'DISPID_SRGRecoContext', 'DISPID_SREmulateRecognition',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SAVolume', 'SVP_5',
    'DISPID_SPEAudioStreamOffset',
    'ISpeechGrammarRuleStateTransitions', 'SPRS_INACTIVE',
    'eLEXTYPE_PRIVATE16', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechPhraseInfo', 'SRATopLevel',
    'ISpeechGrammarRuleState', 'DISPID_SpeechLexiconPronunciation',
    'SVP_15', 'ISpNotifySource', 'SPVPRI_NORMAL', 'SITooLoud',
    'DISPID_SPCLangId', 'DISPID_SpeechPhraseElement',
    'ISpGrammarBuilder', 'DISPID_SPANumberOfElementsInResult',
    'SPRST_ACTIVE', 'DISPID_SpeechRecoContext',
    'DISPID_SRCEInterference', 'DISPID_SRRTLength', 'SREInterference',
    'DISPID_SRGDictationLoad', 'SpInprocRecognizer',
    'SVEWordBoundary', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_PRIVATE1',
    'SpResourceManager', 'DISPID_SGRAddResource', 'SPCT_DICTATION',
    'SVSFParseSapi', 'DISPID_SABIBufferSize',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SFSClose',
    'SP_VISEME_17', 'SPPS_Interjection', 'SPEVENTSOURCEINFO',
    'eLEXTYPE_PRIVATE3', 'SPEI_SR_RETAINEDAUDIO',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechAudio', 'SVSFVoiceMask',
    'STCInprocHandler', 'DISPID_SPEsCount', 'SVP_21', 'DISPIDSPTSI',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_SR_PRIVATE', 'ISpMMSysAudio',
    'DISPID_SPRs_NewEnum', 'SpNotifyTranslator', 'SDTRule',
    'DISPID_SVGetProfiles', 'LONG_PTR', 'DISPID_SVAudioOutputStream',
    'ISpeechPhraseElement', 'SpeechCategoryAudioOut',
    'eLEXTYPE_PRIVATE4', 'DISPID_SpeechLexiconWords',
    'DISPID_SRRTimes', 'SPSHORTCUTTYPE', 'eLEXTYPE_PRIVATE12',
    'SpeechTokenContext', 'SASClosed', 'DISPID_SRCESoundEnd',
    'SAFT22kHz8BitMono', 'SPINTERFERENCE_TOOFAST', 'SRTReSent',
    'SPSTREAMFORMATTYPE', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVPriority', 'tagSPPROPERTYINFO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVP_18',
    'DISPID_SPRulesCount', 'SAFTCCITT_uLaw_44kHzMono',
    'SREStreamStart', 'SPAS_RUN', 'DISPID_SGRId',
    'IInternetSecurityMgrSite', 'SPEI_SOUND_START', 'SREAudioLevel',
    'SpeechPropertyResourceUsage', 'DISPID_SPARecoResult',
    'DISPID_SRCEBookmark', 'DISPID_SADefaultFormat',
    'DISPID_SOTsItem', 'eLEXTYPE_RESERVED8', 'SpMMAudioOut',
    'SpeechRegistryUserRoot', 'DISPID_SpeechPhoneConverter',
    'SP_VISEME_2', 'SVSFPersistXML', 'STSF_CommonAppData',
    'SPSHORTCUTPAIRLIST', 'SGRSTTTextBuffer', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRCRetainedAudio', 'DISPID_SPPNumberOfElements',
    'SPAR_Medium', 'DISPID_SVSLastStreamNumberQueued',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechGrammarRuleState', 'SPPS_LMA', 'SPAS_PAUSE',
    'ISpeechAudioFormat', 'DISPID_SVEEnginePrivate',
    'SPEI_START_INPUT_STREAM', 'SPEI_RESERVED6',
    'DISPID_SPELexicalForm', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SVSInputSentenceLength', 'DISPID_SFSOpen',
    'SpeechAudioFormatType', 'DISPID_SLWPronunciations', 'tagSTATSTG',
    'SDKLLocalMachine', 'DISPID_SpeechPhraseElements',
    'DISPID_SVEPhoneme', 'SECNormalConfidence', 'ISpeechMMSysAudio',
    'SAFTCCITT_uLaw_22kHzMono', 'SVSFNLPSpeakPunc',
    'DISPID_SRSClsidEngine', 'DISPID_SRRAudioFormat',
    'SPXRO_Alternates_SML', 'SPPARTOFSPEECH', 'ISpeechRecoResult2',
    'SRSActive', 'DISPID_SPEDisplayText', 'DISPID_SRGRules',
    'SAFTGSM610_22kHzMono', 'DISPID_SRCERecognition',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechVoiceEvent', 'SGRSTTRule',
    'STSF_AppData', 'IEnumSpObjectTokens', 'SPDKL_DefaultLocation',
    'SAFT11kHz16BitStereo', 'DISPID_SPIGrammarId',
    'DISPID_SPEPronunciation', 'SPPROPERTYINFO', 'STCRemoteServer',
    'SPPS_Unknown', 'SPFM_CREATE', 'SVP_7', 'DISPID_SPRText',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SLWType',
    'DISPID_SVSRunningState', 'SPPS_Verb', 'SP_VISEME_16'
]

_check_version('1.1.14', 1654537484.942883)
